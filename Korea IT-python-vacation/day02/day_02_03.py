...
# 둘다 같으면 "로그인성공", 하나라도 다르면 "로그인실패"
#input_id = input("아이디를 입력하세요:")
#input_pw = input("비밀번호를 입력하세요:")
#input_pw = int(input_pw) # 문자 -> 숫자 (자료형변환)
#result =  "로그인성공" if input_id ==real_id and input_pw == real_pw else "로그인실패"
#print(result)
