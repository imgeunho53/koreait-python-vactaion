...
#print(menu[input("메뉴선택>>") + menu[input("메뉴선택>>"))
Ramen = menu.pop("라면")
GimBab = menu.pop("김밥")
total = Ramen + GimBab
print(total)
...
print(names)
# value들만 모아보자
tels = telebook.values()
tels = list(tels)
print(tels)

# items(): (key, value) 쌍을 튜플로 묶어서 리스토로 만들어줌
print(telebook.items())
